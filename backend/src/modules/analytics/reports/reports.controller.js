...
import Ledger from "../../billing/ledger/Ledger.js";
import Product from "../../erp/products/Product.js";
import Customer from "../../erp/customers/Customer.js";
import Supplier from "../../erp/suppliers/Supplier.js";
...
export const getPartyStatement = async (req, res) => {
  try {
    ...
    // Fetch the company/admin details for branding on the statement
