...
class AccountingService {
   ...
   */
  static async createJournalEntry({ description, debitAccount, creditAccount, amount, referenceType, referenceId, session }) {
   ...
   */
  static async recordProduction(production, productName, session) {
    return await this.createJournalEntry({
   ...
   */
  static async deleteReferenceEntries(referenceId, session) {
    return await JournalEntry.deleteMany({ referenceId }).session(session);
  }
}
