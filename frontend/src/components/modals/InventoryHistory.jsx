            ...
            <table className="w-full text-left">
               <thead>
                  <tr className="bg-muted/30 text-[10px] font-black uppercase text-muted-foreground tracking-widest border-b border-border">
                     <th className="px-4 py-4">Protocol Date / Ref</th>
                     <th className="px-4 py-4">Operational Action</th>
                     <th className="px-4 py-4">Matrix Target</th>
                     <th className="px-4 py-4 text-center">Flux</th>
                     <th className="px-4 py-4 text-right pr-4">Final Reserve</th>
                  </tr>
               </thead>
               <tbody className="divide-y divide-border/50">
                  {loading ? (
                     <tr><td colSpan="5" className="p-6 text-center  text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Synchronizing Protocol Ledger...</td></tr>
                  ) : logs.length === 0 ? (
                     <tr><td colSpan="5" className="p-6 text-center text-muted-foreground font-bold text-[10px] uppercase tracking-widest">No protocol movements detected in registry.</td></tr>
                  ) : logs.map((log) => (
