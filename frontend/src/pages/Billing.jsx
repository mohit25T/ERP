...
import { 
  FileText, Search, Printer, Download, Filter, Calendar, 
  CreditCard, ArrowUpRight, TrendingUp, ShieldCheck, Receipt, 
  CheckCircle2, Lock, ArrowDownToLine, Eye, X, FileJson, Truck,
  Activity, Zap, Landmark
} from "lucide-react";
...
const Billing = () => {
  ...
  const handleUpdateEinvoice = async (id, data) => {
    await invoiceApi.updateEinvoiceDetails(id, data);
    fetchInvoices();
  };

  const handleUpdateEwayBill = async (id, data) => {
    await invoiceApi.updateEwayBillDetails(id, data);
    fetchInvoices();
  };
      ...
      <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div className="flex items-center gap-6">
             <div className="w-20 h-20 bg-slate-900 rounded-[2.5rem] shadow-2xl shadow-slate-900/30 flex items-center justify-center group hover:scale-105 transition-transform duration-500">
                <Landmark className="w-10 h-10 text-white group-hover:rotate-12 transition-transform" />
             </div>
             <div>
                <h2 className="text-5xl font-black text-slate-900 tracking-tightest leading-none mb-2">
          ...
          <div className="flex items-center gap-4">
             ...
             <button className="p-4 bg-white border border-slate-100 rounded-2xl shadow-sm hover:bg-slate-50 transition-all active:scale-95 group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative group p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 hover:-translate-y-2 overflow-hidden">
               ...
               <div className="relative z-10">
                  ...
                  <h3 className="text-4xl font-black text-slate-900 tracking-tightest">₹{totalBilled.toLocaleString('en-IN')}</h3>
            ...
            <div className="relative group p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 hover:-translate-y-2 overflow-hidden">
               ...
               <div className="relative z-10">
                  ...
                  <h3 className="text-4xl font-black text-slate-900 tracking-tightest">₹{totalTax.toLocaleString('en-IN')}</h3>
            ...
            <div className="relative group p-10 bg-slate-900 rounded-[3rem] shadow-2xl shadow-slate-900/30 text-white overflow-hidden">
        ...
        {/* Invoice List */}
        <div className="bg-white rounded-[4rem] border border-slate-100 shadow-sm overflow-hidden mb-20 group">
                ...
                <table className="w-full text-left">
                   ...
                   <tbody className="divide-y divide-slate-50">
                      {filteredInvoices.map((inv) => (
                        <tr key={inv._id} className="group/row hover:bg-slate-50/80 transition-all duration-500">
