    ...
    <AppLayout>
      <div className="space-y-4 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
           <div className="p-3 bg-white rounded-md border border-slate-100 shadow-sm flex flex-col justify-between">
           ...
           <div className="p-3 bg-primary/5 rounded-md border border-primary/10 shadow-sm flex flex-col justify-between">
              <div className="flex items-center justify-between mb-4">
