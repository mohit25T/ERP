      ...
      <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
           <div className="flex items-center gap-4">
              ...
              <div>
                 <h2 className="text-3xl font-black text-slate-900 tracking-tightest leading-none mb-2  uppercase">Regulatory <span className="text-primary not- text-indigo-600">Terminal</span></h2>
           ...
           <div className="flex items-center gap-4">
              <div className="px-3 py-3 bg-white rounded-2xl border border-slate-100 shadow-sm flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
           <div className="p-4 bg-white rounded-[1.5rem] border border-slate-100 shadow-sm relative overflow-hidden group">
              <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Total Interactions</p>
              <h3 className="text-2xl font-black text-slate-900 tracking-tightest tabular-nums  uppercase">{logs.length} Actions</h3>
           ...
           <div className="p-4 bg-white rounded-[1.5rem] border border-slate-100 shadow-sm group">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Security Alerts</p>
              <h3 className="text-2xl font-black text-slate-900 tracking-tightest tabular-nums ">0 Violations</h3>
           ...
           <div className="col-span-2 p-4 bg-slate-900 rounded-[1.5rem] shadow-2xl shadow-slate-900/20 relative overflow-hidden text-white">
           ...
           <div className="p-4 border-b border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="relative group w-full max-w-md">
                 ...
                 <input 
                    ...
                    className="w-full pl-14 pr-4 py-3 bg-slate-50 border-transparent rounded-[2rem] text-[11px] font-bold outline-none focus:bg-white focus:ring-4 focus:ring-indigo-500/5 focus:border-indigo-500/20 transition-all shadow-inner"
                    value={searchTerm}
              ...
              <div className="flex items-center gap-4">
                  <select 
                    ...
                    className="px-4 py-4 bg-slate-50 border-none rounded-2xl text-[10px] font-black uppercase tracking-widest outline-none focus:ring-4 focus:ring-indigo-500/5 transition-all cursor-pointer"
                  >
                ...
                <table className="erp-table">
                   <thead>
                      <tr className="bg-slate-50/50 text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] border-b border-slate-50">
                         <th className="px-4 py-4 ">Tactical Timeline</th>
                         <th className="px-4 py-4 ">Operational Action</th>
                         <th className="px-4 py-4 ">Sector/Resource</th>
                         <th className="px-4 py-4 ">Identity Proxy</th>
                         <th className="px-4 py-4  text-right pr-20">Network Address</th>
                      </tr>
                   </thead>
                           ...
                           <td className="px-4 py-4">
                              <div className="flex items-center gap-4">
                                 ...
                                 <div className="flex flex-col">
                                    ...
                                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest mt-1 ">{log.createdAt ? new Date(log.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' }) : "--:--"}</span>
                                 </div>
                              </div>
                           </td>
                           <td className="px-4 py-4">
                              <div className="flex items-center gap-3">
                                 ...
                                 <span className="text-[11px] font-black text-slate-900 uppercase tracking-tightest  group-hover:text-indigo-600 transition-colors">{log.action.replace(/_/g, " ")}</span>
                              </div>
                           </td>
                           <td className="px-4 py-4">
