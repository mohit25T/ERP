      ...
      <div className="main-app-content space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
           <div className="flex items-center gap-6">
              ...
              <div>
                 <h2 className="text-3xl font-black text-slate-900 tracking-tightest leading-none mb-2 italic">Capital <span className="text-slate-400 not-italic">Terminal</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           <div className="p-6 bg-white rounded-[1.5rem] border border-slate-100 shadow-sm group hover:border-emerald-200 transition-all duration-500 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-black text-emerald-600 tracking-tightest tabular-nums italic">₹{totalCredits.toLocaleString()}</h3>
           ...
           <div className="p-6 bg-white rounded-[1.5rem] border border-slate-100 shadow-sm group hover:border-rose-200 transition-all duration-500 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-black text-rose-600 tracking-tightest tabular-nums italic">₹{totalDebits.toLocaleString()}</h3>
           ...
           <div className={`p-6 rounded-[1.5rem] shadow-2xl relative overflow-hidden group transition-all ${statement?.totalBalance >= 0 ? "bg-slate-900 shadow-slate-900/20" : "bg-rose-900 shadow-rose-900/20"}`}>
              ...
              <h3 className="text-2xl font-black text-white tracking-tightest tabular-nums italic">
