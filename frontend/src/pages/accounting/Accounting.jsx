...
import {
   ...
   Database, Clock, Link as LinkIcon, ChevronRight
} from "lucide-react";
         ...
         <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
               <div className="flex items-center gap-6">
                  ...
                  <div>
                     <h2 className="text-3xl font-black text-slate-900 tracking-tightest leading-none mb-2 italic">Treasury <span className="text-slate-400 not-italic">Intelligence</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
               {[
                  ...
                  <div
                     ...
                     className={`p-8 rounded-[1.5rem] border transition-all duration-500 cursor-pointer relative overflow-hidden group ${activeTab === tab.id ? 'bg-slate-900 border-slate-900 shadow-2xl shadow-slate-900/20 text-white scale-105 z-10' : 'bg-white border-slate-100 hover:border-slate-300 shadow-sm'}`}
                  >
                     ...
                     <table className="erp-table">
                           ...
                           <tr className="bg-slate-50/50 text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] border-b border-slate-50">
                              {activeTab === "journal" ? (
                                 <>
                                    ...
                                    <th className="px-10 py-3">Narration</th>
                                    <th className="px-10 py-3">Account Matrix</th>
                                    <th className="px-10 py-3 text-right">Debit</th>
                                    <th className="px-10 py-3 text-right pr-20">Credit</th>
                                 </>
                              ) : activeTab === "ledger" ? (
                                 <>
                                    <th className="px-10 py-3">Timestamp</th>
                                    <th className="px-10 py-3">Protocol/Category</th>
                                    <th className="px-10 py-3">Narration Summary</th>
                                    <th className="px-10 py-3">Linked Node</th>
                                    <th className="px-10 py-3 text-right pr-20">Magnitude</th>
                                 </>
                              ) : (
                                 <>
                                    <th className="px-10 py-3">Reference</th>
                                    <th className="px-10 py-3">Entity Analysis</th>
                                    <th className="px-10 py-3 text-right">Invoice Yield</th>
                                    <th className="px-10 py-3 text-right">Settled Amount</th>
                                    <th className="px-10 py-3 text-right pr-20">Remaining Drift</th>
                                 </>
                              )}
                           </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-50">
                           {filteredDetails.map((item) => (
                              <tr key={item._id} className="group erp-row-hover transition-all duration-500">
                                 {activeTab === "journal" ? (
                                    <>
                                    ...
                                    <>
                                       ...
                                       <td className="px-10 py-3 max-w-xs">
